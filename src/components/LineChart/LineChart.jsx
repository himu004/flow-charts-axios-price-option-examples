...
const LineChart = () => {
    ...
    const subjectMarksData = [
        ...
        { id: 2, name: 'Bob', physics: 78, chemistry: 85, math: 100 },
        { id: 3, name: 'Charlie', physics: 92, chemistry: 88, math: 95 },
        { id: 4, name: 'David', physics: 88, chemistry: 35, math: 90 },
        ...
        { id: 9, name: 'Ian', physics: 10, chemistry: 89, math: 84 },
        { id: 10, name: 'Jack', physics: 90, chemistry: 88, math: 92 }
    ];

    return (
        <div className='bg-slate-400 p-5 mb-10'>
            <LChart width={1050} height={400}data={subjectMarksData}>
                <XAxis></XAxis>
                <YAxis></YAxis>
